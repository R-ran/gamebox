...
const ConsolePage = () => {
  ...
  const [thumbnailCarouselIndex, setThumbnailCarouselIndex] = useState(0);
  ...
  const productImages = [
    {
      ...
      alt: 'All-In-One Retro Gaming Console - Blue Quest'
    },
    {
      src: '/console-green.avif',
      alt: 'All-In-One Retro Gaming Console - Emerald Mode (Green)'
    },
    {
      src: '/console-black.avif',
      alt: 'All-In-One Retro Gaming Console - Midnight Dash (Black)'
    },
    {
      src: '/console-purple.avif',
      alt: 'All-In-One Retro Gaming Console - Mystic Flame (Purple)'
    },
    {
      src: '/console-orange.avif',
      alt: 'All-In-One Retro Gaming Console - Nitro Blaze (Orange)'
    },
    {
      src: '/console-red.avif',
      alt: 'All-In-One Retro Gaming Console - Crimson Greed (Red)'
    },
    {
      src: '/console-white.avif',
      alt: 'All-In-One Retro Gaming Console - White Strike'
    },
    {
      src: '/console-yellow.avif',
      alt: 'All-In-One Retro Gaming Console - Electric Yellow'
    }
  ];
  ...
  const getPrice = (qty: number) => {
    if (qty === 1) return { price: 39.99, original: 80, discount: 40.01 };
    if (qty === 2) return { price: 67.98, original: 160, discount: 92.02 };
    if (qty === 4) return { price: 119.97, original: 320, discount: 200.03 };
    return { price: 39.99, original: 80, discount: 40.01 };
  };
  ...
  // 确保选中的图片在当前显示的轮播范围内
  useEffect(() => {
    if (selectedImageIndex < thumbnailCarouselIndex) {
      setThumbnailCarouselIndex(selectedImageIndex);
    } else if (selectedImageIndex >= thumbnailCarouselIndex + 5) {
      setThumbnailCarouselIndex(Math.max(0, selectedImageIndex - 4));
    }
  }, [selectedImageIndex]);

  const toggleSection = (section: 'shipping' | 'specs' | 'games' | 'shippingInfo' | 'consoleSpecs') => {
      ...
      <main style={{ paddingBottom: '180px' }}>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="md:sticky md:top-24 md:self-start">
              ...
              <div className="relative">
                <div className="grid grid-cols-5 gap-2">
                  {productImages.slice(thumbnailCarouselIndex, thumbnailCarouselIndex + 5).map((img, relativeIndex) => {
                    const absoluteIndex = thumbnailCarouselIndex + relativeIndex;
                    return (
                      <button
                        key={absoluteIndex}
                        onClick={() => {
                ...
                {/* 左箭头 */}
                {thumbnailCarouselIndex > 0 && (
                  <button
                    onClick={() => setThumbnailCarouselIndex(prev => Math.max(0, prev - 1))}
                    className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-gray-900 hover:bg-gray-800 text-white p-2 rounded-full border border-gray-700 shadow-lg transition"
                ...
                {/* 右箭头 */}
                {thumbnailCarouselIndex < productImages.length - 5 && (
                  <button
                    onClick={() => setThumbnailCarouselIndex(prev => Math.min(productImages.length - 5, prev + 1))}
                    className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-gray-900 hover:bg-gray-800 text-white p-2 rounded-full border border-gray-700 shadow-lg transition"
            ...
            {/* 右侧：产品信息 */}
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4">All-In-One Retro Gaming Console</h1>
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-gray-400">13 reviews</span>
              </div>
              ...
              <div className="mb-6 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">15,000+ Classic Retro Games</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">🎮</span>
                  <span className="font-semibold">20+ Legendary Consoles</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">🎮</span>
                  <span className="font-semibold">Save & Resume Where You Left Off</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">🎮</span>
                  <span className="font-semibold">12-Hour Battery, No Wifi Required</span>
                </div>
              </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-white">You save £{getPrice(1).discount.toFixed(2)}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold">£{getPrice(1).price.toFixed(2)}</p>
                      <p className="text-sm text-gray-500 line-through">£{getPrice(1).original.toFixed(2)}</p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-white">You save £{getPrice(2).discount.toFixed(2)}</p>
                    </div>
                    <div className="text-right flex-shrink-0 ml-4" style={{ minWidth: '120px' }}>
                      <p className="text-2xl font-bold">£{getPrice(2).price.toFixed(2)}</p>
                      <p className="text-sm text-gray-500 line-through">£{getPrice(2).original.toFixed(2)}</p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-white">You save £{getPrice(4).discount.toFixed(2)}</p>
                    </div>
                    <div className="text-right flex-shrink-0 ml-4" style={{ minWidth: '120px' }}>
                      <p className="text-2xl font-bold">£{getPrice(4).price.toFixed(2)}</p>
                      <p className="text-sm text-gray-500 line-through">£{getPrice(4).original.toFixed(2)}</p>
                    </div>
                  </div>
                  ...
                  {selectedQuantity === 4 && (
                    <div className="mt-3 pt-3 border-t border-purple-500/30 space-y-2">
                      {[1, 2, 3, 4].map((num) => {
                        const dropdownIndex = num + 10; // 使用11-14作为索引，避免与2件购买冲突
                        const selectedColorForIndex = selectedColors[dropdownIndex] || selectedColors[0] || 'White Strike';
                        return (
                          <div key={num}>
                            <label className="block text-sm mb-2">Colour #{num}</label>
              ...
              <div className="border-b border-gray-700">
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🎮</span>
                    <span className="font-semibold">What games are included?</span>
                  </div>
                ...
                {expandedSections.shipping && (
                  <div className="px-4 pb-4 border-t border-gray-700">
                    <p className="text-gray-300 pt-4">
                      GameLab comes preloaded with{' '}
                      <span className="font-bold">15,000+ classics</span>{' '}
                      across GB/GBC/GBA, SNES, PS1, N64, DS, PSP and more, no downloads,
                      no accounts, no Wi-Fi required.
                    </p>
                    <p className="text-gray-300 pt-4">
                      Fan favourites people load first include{' '}
                      <span className="font-semibold">Mario Kart</span>,{' '}
                      <span className="font-semibold">Street Fighter II</span>,{' '}
                      <span className="font-semibold">Sonic</span>,{' '}
                      <span className="font-semibold">Crash</span>,{' '}
              ...
              <div className="border-b border-gray-700">
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">👤</span>
                    <span className="font-semibold">Play Together &amp; Trading</span>
                  </div>
                ...
                {expandedSections.specs && (
                  <div className="px-4 pb-4 border-t border-gray-700 space-y-4">
                    <p className="text-gray-300 pt-4">
                      Yes, you can <span className="font-semibold">play multiplayer</span> by pairing two GameLabs
                      for head-to-head racing and party nights.
                    </p>
                    <p className="text-gray-300">
                      Want <span className="font-semibold">real trades and evolutions</span> in supported titles? Add
                      the <span className="font-semibold">Wi-Fi dongle</span>, connect both consoles to the same home
                      network, and complete the swap on-screen.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border-b border-gray-700">
                ...
                {expandedSections.games && (
                  <div className="px-4 pb-4 border-t border-gray-700">
                    <p className="text-gray-300 pt-4">
                      Your GameLab is covered by a{' '}
                      <span className="font-semibold">12-month warranty</span>{' '}
                      against faults. If something goes wrong, we’ll{' '}
                      <span className="font-semibold">repair or replace it.</span>
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border-b border-gray-700">
                ...
                {expandedSections.shippingInfo && (
                  <div className="px-4 pb-4 border-t border-gray-700 space-y-4">
                    <p className="text-gray-300 pt-4">
                      Our <span className="font-semibold">standard delivery within the United Kingdom</span> is{' '}
                      <span className="font-semibold">7–15 business days</span> with tracking included, and this option
                      is <span className="font-semibold">free</span>.
                    </p>
                    <p className="text-gray-300">
                      For a faster option,{' '}
                      <span className="font-semibold">Priority Tracked Shipping (2–8 business days)</span> is available
                      for <span className="font-semibold">£4.99</span>.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border-b border-gray-700">
                ...
                {expandedSections.consoleSpecs && (
                  <div className="px-4 pb-4 border-t border-gray-700 space-y-3">
                    <p className="text-gray-300 pt-4">
                      <span className="font-semibold">CPU:</span> RK3326 64-bit Quad-Core 1.5GHz
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">RAM:</span> 1GB DDR3L
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">Display:</span> 3.5&quot; IPS HD
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">GPU:</span> Mali-G31MP2
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">Storage:</span> 64GB internal + expandable slot for more
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">Battery:</span> 3200 mAh – reliable power for longer gaming sessions
                    </p>
                  </div>
                )}
              </div>
           ...
           <div>
            ...
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                Relive the Classics.<br />Anywhere. Anytime.
              </h2>
              ...
              <p className="text-gray-300 text-lg mb-4">
                15,000+ legendary games, no setup, no downloads, and zero internet required.
              </p>
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div>
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg mb-4">
                Press <span className="font-semibold">Select + X</span> to drop a save before a boss, tricky jump, or
                final lap.
              </p>
              <p className="text-gray-300 text-lg">
                Miss it? Load. Try again. No restarts.
              </p>
            </div>
          </div>
        </section>

        {/* Section 4: One Device. All The Classics. */}
        <section className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* 左侧文字 */}
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                One Device. All The<br className="hidden md:block" />Classics.
              </h2>
              <p className="text-gray-300 text-lg mb-4">
                Power on. Pick a game. Disappear for a while.
              </p>
              <p className="text-gray-300 text-lg">
                No downloads, no accounts, no Wi-Fi required, just the hits from every era, ready when you are.
              </p>
            </div>
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex-shrink-0 w-20 h-20 bg-gray-800 rounded-lg border-2 overflow-hidden transition ${
